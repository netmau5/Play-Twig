...
The Twig Persistence framework is a typesafe, DSL-based persistence framework for the Google App Engine datastore. Twig pleasantly batch operations, in-memory joins, and asynchronous queries, allowing the developer side-step some of the annoying work associated with working with the datastore.
